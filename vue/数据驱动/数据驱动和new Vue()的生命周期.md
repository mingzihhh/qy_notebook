...
合并配置，初始化生命周期，初始化事件中心，初始化渲染   //beforeCreate

初始化 data，props，computed，watch，methods 等等   //created
...
渲染vnode把vnode patch到真实dom，实例化watcher     //mounted
...
执行diff算法，对比改变是否需要触发UI更新   //beforeupdated

组件已更新    //updated

---

$destroy函数最开始执行的地方   //beforedestroy
